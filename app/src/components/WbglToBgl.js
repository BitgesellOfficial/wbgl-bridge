...
function WbglToBgl() {
  return (
    <form noValidate autoComplete="off">
      ...
      <TextField variant="filled" id="signed-bgl-address" label="Signed BGL address" fullWidth required multiline helperText="Sign your BGL address with your Ethereum wallet's private key and paste the result here." />
